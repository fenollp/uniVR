// Shader downloaded from https://www.shadertoy.com/view/4dS3RG
// written by shadertoy user mplanck
//
// Name: Alias Vortex
// Description: Continued tinkering of my Blended DDA Marching shadertoy.  Blends between smaller and larger cell sizes every 10 seconds.  Set the MIN_CELLSIZE to 1 if you have a fast-ish machine.
// **************************************************************************
// CONSTANTS
