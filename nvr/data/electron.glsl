// Shader downloaded from https://www.shadertoy.com/view/MslGRn
// written by shadertoy user gopher
//
// Name: electron
// Description: quick glsl port of an effect used in a 4k from 2007.<br/>use mouse to rotate (x) and zoom (y)<br/><br/>
