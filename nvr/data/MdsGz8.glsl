// Shader downloaded from https://www.shadertoy.com/view/MdsGz8
// written by shadertoy user fizzer
//
// Name: Marching Cubes
// Description: Obviously not the famous 'marching cubes' polygonisation algorithm, but I couldn't resist the opportunity to use a pun like this!
// @eddbiddulph
