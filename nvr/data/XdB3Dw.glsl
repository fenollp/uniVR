// Shader downloaded from https://www.shadertoy.com/view/XdB3Dw
// written by shadertoy user fizzer
//
// Name: The Popular Shader
// Description: I remade my other shader (https://www.shadertoy.com/view/ldjGWD) inspired by "The Popular Demo", to make it more accurate <img src="/img/emoticonHappy.png"/><br/>I added a tiling effect to make the robot look faceted, but it seems to somehow over-complicate the shader so it doesn't compile.
