// Shader downloaded from https://www.shadertoy.com/view/MsjSzz
// written by shadertoy user TDM
//
// Name: Da Rasterizer
// Description: smooth rasterize line and circle shapes<br/>and a little 3d pipeline <img src="/img/emoticonHappy.png"/>
