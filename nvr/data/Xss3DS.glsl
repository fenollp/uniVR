// Shader downloaded from https://www.shadertoy.com/view/Xss3DS
// written by shadertoy user huwb
//
// Name: Anatomy of an explosion
// Description: Instructions: Click and drag!<br/><br/>My first steps in volume rendering, hope it's instructive for others. This started life as, and borrows much from, iq's Hell shader.<br/><br/>It takes bigger steps in empty space similar to marching through a distance field.
