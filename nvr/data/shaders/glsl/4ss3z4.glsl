// Shader downloaded from https://www.shadertoy.com/view/4ss3z4
// written by shadertoy user ztri
//
// Name: Shady Building
// Description: Playing with lights, shadows and a bit larger model
float time;
