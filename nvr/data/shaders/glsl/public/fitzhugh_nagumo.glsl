// Shader downloaded from https://www.shadertoy.com/view/XdcXDN
// written by shadertoy user cornusammonis
//
// Name: Fitzhugh-Nagumo
// Description: Fitzhugh-Nagumo reaction-diffusion system. Try it in fullscreen and paint with mouse controls.
/*
...
float bumpFunc(vec2 p){ 
    return 0.5 * (texture2D(iChannel1, p).x + 1.0);
}
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
    ...
    vec3 texCol = texture2D(iChannel0, sp.xy).xyz;
