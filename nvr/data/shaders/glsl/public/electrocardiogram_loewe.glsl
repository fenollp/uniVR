// Shader downloaded from https://www.shadertoy.com/view/XsyGzD
// written by shadertoy user Loewe
//
// Name: Electrocardiogram_Loewe
// Description: This is my first shader program that make me satisfied
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    uv2.x -= 2.0*mod(iGlobalTime,1.0*iResolution.x/iResolution.y);
