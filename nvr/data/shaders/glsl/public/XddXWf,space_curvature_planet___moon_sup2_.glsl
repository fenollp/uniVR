// Shader downloaded from https://www.shadertoy.com/view/XddXWf
// written by shadertoy user aiekick
//
// Name: Space Curvature Planet + Moon&sup2;
// Description: Space Curvature Planet + Moon + Moon of Moon ^^ but what is the name of a moon of moon ?? :)
...
vec4 sph1 = vec4( cos(iGlobalTime*.5)*.5, 0.0, sin(iGlobalTime*.5)*.5, 1.0 );//#

// moon coord
vec4 sph2 = sph1 + vec4( cos(iGlobalTime*.7)*2., 0.0, sin(iGlobalTime*.7)*2.5, -.8 );//#

vec4 sph3 = sph2 + vec4( cos(-iGlobalTime*2.)*.5, 0.0, sin(-iGlobalTime*2.)*.5, -.15 );//#
