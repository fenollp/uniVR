// Shader downloaded from https://www.shadertoy.com/view/4tSGWV
// written by shadertoy user ridhojeftha
//
// Name: Photoshop Blend Modes
// Description: Ps modes
//Darken
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    int time = int (mod (iGlobalTime, 18.0));
    ...
    if (time==0) finalImage =  darken ( upperTexture,  lowerTexture	);
            ...
            else if (time== 17) finalImage = divide(upperTexture, lowerTexture);
