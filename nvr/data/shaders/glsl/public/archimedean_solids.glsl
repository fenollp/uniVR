// Shader downloaded from https://www.shadertoy.com/view/Mll3zB
// written by shadertoy user paniq
//
// Name: Archimedean Solids
// Description: Regular solids formed by intersections between cube, octahedron (the cube's dual) and rhombic dodecahedron, an interpolation of the cube and its dual. Uses IQ's 3D template.
//    
