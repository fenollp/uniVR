// Shader downloaded from https://www.shadertoy.com/view/4dy3zV
// written by shadertoy user paniq
//
// Name: Implicit Motion Gradients
// Description: Sampling the same field at two different times to build a motion vector. This is useful for systems where surface particles need to track a changing surface. Hold mouse to see time gradient at that position.
