// Shader downloaded from https://www.shadertoy.com/view/Xs33Df
// written by shadertoy user Shane
//
// Name: Desert Canyon
// Description: Traversing a desert canyon.
/*
	Desert Canyon
	-------------
	...
	indoor and outdoor lighting, but keep it simple enough to allow reasonable framerates for swift 
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){	
	...
	// Camera Setup.
	vec3 lookAt = vec3(0.0, 0.0, iGlobalTime*8.);  // "Look At" position.
