// Shader downloaded from https://www.shadertoy.com/view/XtSSWK
// written by shadertoy user aiekick
//
// Name: Curve Derivative
// Description: use mouse for set the x position of point
//    a study for finidng the up cam direction for a roller coaster like
//    this is a not finished work ^^ [url=https://www.shadertoy.com/view/4tSSWK]Roller Coaster[/url] ^^
