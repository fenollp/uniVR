// Shader downloaded from https://www.shadertoy.com/view/4stSWf
// written by shadertoy user vox
//
// Name: Cellular Activities
// Description: Cellular Activities

#define PI 3.14159265359
#define E 2.7182818284
#define GR 1.61803398875

#define time ((saw(float(__LINE__))*.001+1.0)*iGlobalTime/PI+100.0)
