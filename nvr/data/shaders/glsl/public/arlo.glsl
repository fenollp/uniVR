// Shader downloaded from https://www.shadertoy.com/view/4dtGWM
// written by shadertoy user iq
//
// Name: Arlo
// Description: Arlo, from the movie The Good Dinosaur, approximated by a procedural distance field. Go see the movie! 
//    Also, I'm using analytical derivatives (ray differentials) to do heightmap and texture filtering without edge artifacts.
