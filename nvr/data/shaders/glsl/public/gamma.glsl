// Shader downloaded from https://www.shadertoy.com/view/Xdl3DM
// written by shadertoy user iq
//
// Name: Gamma
// Description: Move the mouse until the circles and the middle of the gradient blend with the background.
