// Shader downloaded from https://www.shadertoy.com/view/Xd23Dh
// written by shadertoy user iq
//
// Name: Voronoise
// Description: Patterns such as cell-noise, perlin noise and voronoi can be seen as particular cases of a more general pattern, which I call &quot;voronoise&quot;. More info [url= http://iquilezles.org/www/articles/voronoise/voronoise.htm]in this article[/url]. 
