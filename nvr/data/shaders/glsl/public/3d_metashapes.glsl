// Shader downloaded from https://www.shadertoy.com/view/Xls3R7
// written by shadertoy user LeWiZ
//
// Name: 3D metashapes
// Description: My first 3D shader. &quot;Metaballs&quot; using various shapes (box, sphere, torus).
//    Thanks to iq for the tutorials and articles.
//    
//    Update : softer diffuse shadows
//    Update : now the phong shading is correct
