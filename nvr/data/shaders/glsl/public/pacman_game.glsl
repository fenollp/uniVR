// Shader downloaded from https://www.shadertoy.com/view/Ms3XWN
// written by shadertoy user iq
//
// Name: Pacman Game
// Description: Arrow keys to move. SPACE bar to restart. I'll implement levels next time I have some more time to spare
