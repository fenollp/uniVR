// Shader downloaded from https://www.shadertoy.com/view/ld2GRz
// written by shadertoy user iq
//
// Name: Metaballs - Quintic
// Description: Bounded metaballs with quintic falloff. Literature often recommends cubic (smoothstep) falloffs (rather than exponential or 1/d&sup2;) for they are bounded. However they produce discontinuities in normals/lighting. Quintic falloffs solves the problem.
