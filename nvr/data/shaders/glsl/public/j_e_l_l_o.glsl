// Shader downloaded from https://www.shadertoy.com/view/4lXSDf
// written by shadertoy user demofox
//
// Name: J-E-L-L-O
// Description: Trying to use beer's law to make a cube of jello.  Anyone have any tips for improving it's look??
