// Shader downloaded from https://www.shadertoy.com/view/4sdXDX
// written by shadertoy user Shane
//
// Name: Smooth Voronoi Contours
...
/*
	...
	layers of smooth 2D Voronoi and an old concetric circle trick. In pseudo code:
...
vec2 hash22(vec2 p) {
    ...
    return cos(p*6.283 + iGlobalTime)*.5;
...
// smooth pattern. The "falloff" variable is a smoothing factor.
//
