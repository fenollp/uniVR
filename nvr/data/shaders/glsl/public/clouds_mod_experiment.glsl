// Shader downloaded from https://www.shadertoy.com/view/lljXWG
// written by shadertoy user Duke
//
// Name: Clouds mod experiment
// Description: Frankly I'm not sure whether it was necessary to publish this shader, as changes in comparison with the original are small. But perhaps it will seem interesting to someone. Main code is from iq's &quot;Clouds&quot; demo and noises from otaviogood's &quot;Alien Beacon&quot;
