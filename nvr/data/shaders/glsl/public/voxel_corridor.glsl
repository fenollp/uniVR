// Shader downloaded from https://www.shadertoy.com/view/MdVSDh
// written by shadertoy user Shane
//
// Name: Voxel Corridor
// Description: Utilizing fb39ca4's, IQ's, Reinder's, etc, voxel code to produce a very simple block work corridor.
/*
...
/*
// Alternate distance field. Twisted planes. You may need to repostion the light
// to work in with the shadows.
float map(vec3 p){
...
// The execuation, not so much. :) So damn fiddly. Thankfully, fb39ca4, IQ, and a few 
...
void mainImage( out vec4 fragColor, in vec2 fragCoord ){
	...
	// Camera Setup.
	vec3 lookAt = vec3(0., 0.5, iGlobalTime*8. + 0.1);  // "Look At" position.
