// Shader downloaded from https://www.shadertoy.com/view/lsdSDj
// written by shadertoy user vox
//
// Name: Perfect Tree Spiral
// Description: Reduced code by ~200 characters. Didn't use last rotateZ suggestion because one of my rotateZ's is for squares defined by 4 vertices. Thanks, as always, Fabrice!
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    uv *= scale;
    uv -= scale/2.0;
    //uv.xy += vec2(cos(iGlobalTime*.234), sin(iGlobalTime*.345))*1.0;
