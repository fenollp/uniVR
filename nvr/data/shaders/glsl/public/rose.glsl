// Shader downloaded from https://www.shadertoy.com/view/ldBGDh
// written by shadertoy user Dave_Hoskins
//
// Name: Rose
// Description: I had to use an X wrapped 2D noise, so the atan result would repeat properly when passing through 360 degrees.
//    
