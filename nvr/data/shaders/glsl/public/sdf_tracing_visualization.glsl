// Shader downloaded from https://www.shadertoy.com/view/lslXD8
// written by shadertoy user paniq
//
// Name: SDF Tracing Visualization
// Description: Testbed for tracing; probably only works on Chrome for Linux ;-)
// trace visualization
// -- @paniq
