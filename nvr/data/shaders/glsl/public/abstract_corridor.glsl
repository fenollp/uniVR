// Shader downloaded from https://www.shadertoy.com/view/MlXSWX
// written by shadertoy user Shane
//
// Name: Abstract Corridor
// Description: Using Nimitz's triangle noise idea and his curvature function to fake an abstract, flat-shaded, point-lit, mesh look.
/*
    Abstract Corridor
    -------------------
