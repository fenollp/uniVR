// Shader downloaded from https://www.shadertoy.com/view/ltfSRN
// written by shadertoy user demofox
//
// Name: 1D Cubic Uniform B-Spline
// Description: 1D Cubic B-Spline.  Mouse controls the yellow control point.
//    There are 4 control points A,B,C,D and implicitly 8 knots: [0,1,2,3,4,5,6,7]. Only time 3.0 through 4.0 are valid due to how bsplines work.
