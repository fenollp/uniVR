// Shader downloaded from https://www.shadertoy.com/view/MtlGR2
// written by shadertoy user bergi
//
// Name: kalizyl und kalizul
// Description: we're getting there...
//    i could link to eiffies last shader but it's on a page that crashes this browser ..
...
#define mph (.5 + .5 * Tanh(sin(iGlobalTime/9.123+1.2)*7.))
