// Shader downloaded from https://www.shadertoy.com/view/ls2GRt
// written by shadertoy user movAX13h
//
// Name: Flappy Bird
// Description: The bird is composed of bit encoded integer numbers (3bit/px = 8 colors, 24bit/int, 204px =&gt; 26 ints).
