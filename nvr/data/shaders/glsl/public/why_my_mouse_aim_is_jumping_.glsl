// Shader downloaded from https://www.shadertoy.com/view/XsySDR
// written by shadertoy user foxes
//
// Name: Why my mouse aim is jumping?
// Description: many do not understand why the pointer jumps when viewed from another angle, now you can see why. just change the mouse vertical viewing angle. (thanks IQ for examples https://www.shadertoy.com/view/Xds3zN)
