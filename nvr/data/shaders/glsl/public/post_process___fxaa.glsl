// Shader downloaded from https://www.shadertoy.com/view/ls3GWS
// written by shadertoy user reinder
//
// Name: Post process - FXAA
// Description: Demonstrating post process FXAA on my shader [url=https://www.shadertoy.com/view/Xtf3zn]Tokyo[/url]. 
//    
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    if( uv2.x < splitCoord/iResolution.x ) {
	    ...
	    col = texture2D( iChannel0, uv2 ).xyz;
    }
