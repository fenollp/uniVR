// Shader downloaded from https://www.shadertoy.com/view/XdSGDc
// written by shadertoy user Dave_Hoskins
//
// Name: Rainy London
// Description: Thanks to P_Malin for doing the model locations. I've re-used quite a lot of that code to start this, and added some furniture.
//    Uses rain sheets that catch the light sources, note the orange rain when near the bollard. Plus distance blurring of texture.
// Rainy London
// By David Hoskins.
