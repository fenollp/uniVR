// Shader downloaded from https://www.shadertoy.com/view/4dcSRH
// written by shadertoy user Mr_E
//
// Name: 3 Dimensional Grid 
// Description: This is a 3D grid based off of my general 3 dimensional code for generic, rounded shapes. This is a test based off of the original test for rounded shapes, and has been changed to my advantage. This uses a different rotational function for the camera pos.
...
{
    vec3 cam_pos = vec3(cos(iGlobalTime/6.)*30.0,sin(iGlobalTime/5.)*40.0,20.0);
    ...
    if (f<maxd) {
        ...
        //fragColor = vec4(b, 0.1, b, cos(iGlobalTime));//Set the screen pixel to that color
    } else {
