// Shader downloaded from https://www.shadertoy.com/view/ll23zm
// written by shadertoy user leon
//
// Name: Pixel Portrait Shining
// Description: An image effect inspired by manga FX and pixel art. Made for Zoo Machines festival (http://zoomachines.com)
//    Setup iChannel0 with a video if no webcam.
#define PI 3.1416
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // Pixelate
   	uv = pixelate(uv, iResolution.xy / 4.0);
