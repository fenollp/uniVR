// Shader downloaded from https://www.shadertoy.com/view/4tfGzr
// written by shadertoy user dr2
//
// Name: Toy Train
// Description: In the predigital age every kid wanted a toy train; here is the virtual version (every so often there is a closeup view).
