// Shader downloaded from https://www.shadertoy.com/view/XdsGWs
...
//    
//    star proj = fraction of captor pixel.
//    But lense+aperture diffraction yields Airy spot + cross (diffract on 2ndary mirror handles). 
