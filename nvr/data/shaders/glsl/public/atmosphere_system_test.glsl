// Shader downloaded from https://www.shadertoy.com/view/XtBXDz
// written by shadertoy user valentingalea
//
// Name: Atmosphere system test
// Description: WIP of realistically modeling the atmosphere.
//    
//    Mouse click to change from space to ground view.
// ----------------------------------------------------------------------------
