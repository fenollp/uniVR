// Shader downloaded from https://www.shadertoy.com/view/MsfGzr
// written by shadertoy user XT95
//
// Name: To the road of ribbon
// Description: A raymarched tunnel with a ribbon and a reflection pass
float tunnel(vec3 p)
{
