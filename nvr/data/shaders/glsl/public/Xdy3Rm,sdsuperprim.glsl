// Shader downloaded from https://www.shadertoy.com/view/Xdy3Rm
// written by shadertoy user paniq
//
// Name: sdSuperprim
// Description: An improved version of sdSuperpill() that is able to represent a wide range of rectangular-radial primitives of genus 0 and 1: (round) box, sphere, cylinder, pill, pellet, pipe, torus, etc. Drag the mouse for custom shapes.
