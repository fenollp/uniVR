// Shader downloaded from https://www.shadertoy.com/view/4dK3WK
// written by shadertoy user demofox
//
// Name: Jump Flood Algorithm: Weight Pts
// Description: A spin off from https://www.shadertoy.com/view/Mdy3DK, applying dfa to weighted points.
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    if (length(fragCoord-seedCoord) > (3.0 / seedWeight))
        seedColor *= 0.75;
