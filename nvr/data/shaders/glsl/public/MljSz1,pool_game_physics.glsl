// Shader downloaded from https://www.shadertoy.com/view/MljSz1
// written by shadertoy user archee
//
// Name: pool game physics
// Description: continuously timed physics with collisions.
//    mouse.y = initial Y coordinate of white ball
//    mouse.x = angle of shooting the white ball
//    
//    No iMouse input in sound shader -&gt; no sound
