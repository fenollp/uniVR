// Shader downloaded from https://www.shadertoy.com/view/MscXRH
...
{  
    ...
    a = sin(vec2(1.5707963, 0) + cos(iGlobalTime*0.1875*.7)*.7);
    rM = mat2(a, -a.y, a.x); 
    rd.xz = rd.xz*rM;
