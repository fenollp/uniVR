// Shader downloaded from https://www.shadertoy.com/view/XsdGDX
// written by shadertoy user demofox
//
// Name: Snake Game
// Description: Raytraced snake game.  Collect the red apples and don't crash! Arrow keys to move, mouse drag to control camera.  Space to reset if you crash the snake. 
//    Primary rays + environment mapping only.  No reflection, refraction or shadows.
