// Shader downloaded from https://www.shadertoy.com/view/MsjGRt
// written by shadertoy user iapafoto
//
// Name: [NV15] Invader's
// Description: Try to make a short animation with various sequences, objects, effects, movements, materials and textures
//    [Mouse] Control camera angle
//    (code is not cleaned for the moment)
