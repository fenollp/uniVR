// Shader downloaded from https://www.shadertoy.com/view/4sfGWX
// written by shadertoy user reinder
//
// Name: Wolfenstein 3D
// Description: Experiment to generate some well-known textures in a textureless shader. This shader is work in progress. 
//    Feel free to add comments, suggestions or a clever method to generate the most used wall texture in Wolfenstein (irregular grey bricks).
