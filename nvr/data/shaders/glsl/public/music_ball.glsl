// Shader downloaded from https://www.shadertoy.com/view/ldf3RH
// written by shadertoy user PauloFalcao
//
// Name: Music ball
// Description: An experiment using the fft sound texture.
//    Try using a video, the effect is probably even cooler than the sound fft LOL
