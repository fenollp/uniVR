// Shader downloaded from https://www.shadertoy.com/view/XlSGDc
// written by shadertoy user eiffie
//
// Name: paxis2
// Description: I thought dila's paxis function needed a sister paxis2 that returns 2 major axes.
//    The nice synth (fake harmonics) are from jnorberg. See code for links.
float rnd,sizer;
