// Shader downloaded from https://www.shadertoy.com/view/MdKSzR
// written by shadertoy user vox
//
// Name: Dancing Galaxies 7
// Description: Dancing Galaxies 7
//-----------------SETTINGS-----------------
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    float sound = texture2D(iChannel0, uv).r;
    ...
    fragColor = vec4(final, 1.0)*smoothstep(0.0, .01, height*sound*(1.0-ifsPowed));
