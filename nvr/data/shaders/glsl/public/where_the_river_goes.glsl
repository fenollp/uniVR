// Shader downloaded from https://www.shadertoy.com/view/Xl2XRW
// written by shadertoy user P_Malin
//
// Name: Where the River Goes
// Description: What started as a hacked flow and advection experiment turned into something nice.
//    
//    If you have a (very) fast GPU, try uncommenting #define ENABLE_ULTRA_QUALITY
