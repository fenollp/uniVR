// Shader downloaded from https://www.shadertoy.com/view/lssSWH
// written by shadertoy user paniq
//
// Name: Interval Arithmetic
// Description: raymarching using interval arithmetic - allows tracing arbitrary implicit functions without euclidean distance metrics; drag mouse for demo.
//    inspired by http://www.cs.utah.edu/~knolla/cgrtia.pdf
//    uses bisection, there are better methods.
// trace visualization
// -- @paniq
