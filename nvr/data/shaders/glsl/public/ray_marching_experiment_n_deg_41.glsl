// Shader downloaded from https://www.shadertoy.com/view/ldcSzN
// written by shadertoy user aiekick
//
// Name: Ray Marching Experiment n&deg;41
// Description: Ray Marching Experiment n&deg;41
...
vec3 effect(vec2 g) 
{
    ...
    return vec3(1.-step(.1/ fract( cos(6e4 * (sin(iGlobalTime*0.000001)+.5) * length ( floor(g) )) < -.8 ? g.x: g.y ), .6));
}
