// Shader downloaded from https://www.shadertoy.com/view/llfSRN
// written by shadertoy user demofox
//
// Name: 1D Linear Uniform B-Spline II
// Description: 1D Linear B-Spline.  Use the mouse to control the yellow control point.
