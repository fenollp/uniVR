// Shader downloaded from https://www.shadertoy.com/view/ld2Gz3
// written by shadertoy user McZonk
//
// Name: Lights on
// Description: Porting my thesis from 2006 to Shadertoy.<br/>No shadows and occlusions yet.
struct Ray {
	vec3 origin;
	vec3 direction;
};
