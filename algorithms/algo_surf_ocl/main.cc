...
cv::Mat
drawGoodMatches (const cv::Mat& cpu_img1,
                 const cv::Mat& cpu_img2,
    ...
    line(img_matches,
         scene_corners[0] + Point2f((float)cpu_img1.cols, 0),
         scene_corners[1] + Point2f((float)cpu_img1.cols, 0),
         cv::Scalar(0,255,0), 2, LINE_AA);
    line(img_matches,
         scene_corners[1] + Point2f((float)cpu_img1.cols, 0),
         scene_corners[2] + Point2f((float)cpu_img1.cols, 0),
         cv::Scalar(0,255,0), 2, LINE_AA);
    line(img_matches,
         scene_corners[2] + Point2f((float)cpu_img1.cols, 0),
         scene_corners[3] + Point2f((float)cpu_img1.cols, 0),
         cv::Scalar(0,255,0), 2, LINE_AA);
    line(img_matches,
         scene_corners[3] + Point2f((float)cpu_img1.cols, 0),
         scene_corners[0] + Point2f((float)cpu_img1.cols, 0),
...
int main(int argc, char* argv[])
{
    ...
    cv::ocl::oclMat keypoints1GPU, keypoints2GPU;
    cv::ocl::oclMat descriptors1GPU, descriptors2GPU;
