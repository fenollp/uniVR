// Shader downloaded from https://www.shadertoy.com/view/MsSGD1
// written by shadertoy user HLorenzi
//
// Name: Hand-drawn Sketch
// Description: Hand-drawn effect with hatching and edge detection! Drag the mouse around! Looks better on Shadertoy's in-page resolution (as above, not full screen). Shadows got broken recently, so I removed them!
