// Shader downloaded from https://www.shadertoy.com/view/XtfGzj
// written by shadertoy user Kali
//
// Name: Space Race
// Description: One of the battles I lost with webgl... only working for me in low_quality mode <img src="/img/emoticonSad.png"/> - Btw, this was a collab with one of my masters, eiffie, who made the car modelling <img src="/img/emoticonHappy.png"/>
// "Space Racing Lite"  
