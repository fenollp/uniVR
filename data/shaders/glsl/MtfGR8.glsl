// Shader downloaded from https://www.shadertoy.com/view/MtfGR8
// written by shadertoy user jimanjr
//
// Name: Snowglobe_v2
// Description: Hello, this is the final version of the Snowglobe shader I made a while ago. Had to keep that unchanged during the voting.<br/><br/>Many thanks to iq and TekF for some of the functions.
