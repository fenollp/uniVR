// Shader downloaded from https://www.shadertoy.com/view/XsdGR8
// written by shadertoy user macbooktall
//
// Name: tunnel2
// Description: small mod of my tunnel https://www.shadertoy.com/view/MlSXWd
...
{
    pos.x += sin(pos.z+iGlobalTime*0.5)*0.275*2.;
    pos.y += cos(pos.z+iGlobalTime*0.5)*0.275*2.;
...
{ 
    ...
    if( m>-0.5 )
    {
		...
		col = hue(vec3(1.0,1.0,.0),iGlobalTime*0.5+pos.z)*occ;
