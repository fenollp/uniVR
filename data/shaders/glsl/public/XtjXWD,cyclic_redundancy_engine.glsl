// Shader downloaded from https://www.shadertoy.com/view/XtjXWD
// written by shadertoy user otaviogood
//
// Name: Cyclic Redundancy Engine
// Description: The Cyclic Redundancy Engine is an infernal machine capable of feats of great redundancy.
//    I also made a short music track to go with this shader (using Ableton).
/*--------------------------------------------------------------------------------------
