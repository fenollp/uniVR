// Shader downloaded from https://www.shadertoy.com/view/Xd3GWn
// written by shadertoy user namortrailblazer
//
// Name: Explosion effect
// Description: I always wanted to do something like this.
//    Got the idea for this explosion from huwb's anatomy of an explosion and iq's hell.
//    
/* Explosion
