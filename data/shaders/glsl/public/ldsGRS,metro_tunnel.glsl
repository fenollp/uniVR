// Shader downloaded from https://www.shadertoy.com/view/ldsGRS
// written by shadertoy user fb39ca4
//
// Name: Metro Tunnel
// Description: Inspired by the tunnels in Metro 2033. Click and drag to move the light along the tunnel.
//    This scene makes heavy use of repeating geometry, as you can see in the train tracks and wall braces. I even  plan to extend this to repeating lights in the future.
