// Shader downloaded from https://www.shadertoy.com/view/lt2GWd
// written by shadertoy user 4rknova
//
// Name: Interpolation: Step
// Description: Step interpolation.
...
vec2 step(vec2 a, vec2 b, float p)
{
    return p < .5 ? a : b;
}
...
{
    vec2 p = step(a, b, mod(iGlobalTime * 2., 10.) / 10.);
...
{ 
    ...
    {
        vec2  p0 = step(a, b, (i   ) / STEPS);
        vec2  p1 = step(a, b, (i+1.) / STEPS);
