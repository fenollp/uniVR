// Shader downloaded from https://www.shadertoy.com/view/MtBGWK
// written by shadertoy user ManuManu
//
// Name: Anti menger Sphere Sponge
// Description: In order to better understand the what was happening in the sphere sponge  (from IQ, I think), I reversed holes and fill parts.
//    
//    Made on GlSlSandbox here :http://glslsandbox.com/e#25180.1
//    
//    
