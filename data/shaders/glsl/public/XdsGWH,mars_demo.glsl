// Shader downloaded from https://www.shadertoy.com/view/XdsGWH
// written by shadertoy user reinder
//
// Name: Mars demo
// Description: Tribute to Tim Clarke's Mars demo from 1993. Click and move your mouse to look around.
//    
