// Shader downloaded from https://www.shadertoy.com/view/MtfSWr
// written by shadertoy user FabriceNeyret2
//
// Name: crowded Lego
// Description: Here, I fix a limitation of the ultra-compact Trisomie21 ray-marcher:
//    If sphere-marching only takes into account the dist to geom in the current 3D tile, then passed an object we might enter to deep in the next tile. Thus the artifacts in my other demos.
