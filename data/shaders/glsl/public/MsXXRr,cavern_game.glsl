// Shader downloaded from https://www.shadertoy.com/view/MsXXRr
// written by shadertoy user XT95
//
// Name: Cavern game
// Description: A small game (delete inadvertently but bugs fixed now!)
//    You must avoid the obstacles by moving the camera with the mouse !
