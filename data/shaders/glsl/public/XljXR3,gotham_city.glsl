// Shader downloaded from https://www.shadertoy.com/view/XljXR3
// written by shadertoy user dr2
//
// Name: Gotham City
// Description: A city without traffic problems, a short day/night cycle, and a skydeck (mousing encouraged).
