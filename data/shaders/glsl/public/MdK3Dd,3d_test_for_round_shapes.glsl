// Shader downloaded from https://www.shadertoy.com/view/MdK3Dd
// written by shadertoy user Mr_E
//
// Name: 3D Test for Round Shapes
// Description: This is my second 3D test, with round shapes! You can see the first one here: https://www.shadertoy.com/view/MsK3Wd
...
{
    vec3 cam_pos = vec3(cos(iGlobalTime/5.)*20.0,sin(iGlobalTime/5.)*30.0,10.0);
