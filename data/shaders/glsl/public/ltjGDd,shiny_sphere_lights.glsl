// Shader downloaded from https://www.shadertoy.com/view/ltjGDd
// written by shadertoy user shaderology
//
// Name: Shiny sphere lights
// Description: Fun with spherical lights, area shadows, occlusion and reflections.
