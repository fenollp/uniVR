// Shader downloaded from https://www.shadertoy.com/view/4dfGW4
// written by shadertoy user Dave_Hoskins
//
// Name: Volcano
// Description: An experiment in smoke particles, that later turned into a volcano! :)
...
float SmokeParticle(vec2 loc, vec2 pos, float size, float rnd)
{
	...
	// Also used 'rnd' as an additional noie changer.
