// Shader downloaded from https://www.shadertoy.com/view/llX3zr
// written by shadertoy user Dave_Hoskins
//
// Name: Space Jewels
// Description: Uses a stack of 8 samples on each pixel to render the fractal. Please watch in full-screen if your GPU is up to it!! :)
//    It uses near field out of focus effects.
