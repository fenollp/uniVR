// Shader downloaded from https://www.shadertoy.com/view/XlBXWc
// written by shadertoy user hughsk
//
// Name: 2015/11/05
// Description: Trying out voxel raytracing for kicks, click and drag to change the terrain. Initial technique sourced from here: https://www.shadertoy.com/view/4dfGzs
vec2 noiseOffset = iMouse.z > 0.0
  ? iMouse.xy * 0.005
  : vec2(0.0);
