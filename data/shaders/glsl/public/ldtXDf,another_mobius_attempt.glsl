// Shader downloaded from https://www.shadertoy.com/view/ldtXDf
// written by shadertoy user vox
//
// Name: Another Mobius Attempt
// Description: Any obvious mistakes?
...
vec2 mobius(vec2 uv)
{
    ...
    return vec2(saw(theta*turns), cosaw(xy.x*PI*1.0));
}
