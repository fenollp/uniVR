// Shader downloaded from https://www.shadertoy.com/view/Msc3zB
// written by shadertoy user skaven
//
// Name: Palette Maker
// Description: A palette maker inspired from http://paletton.com Modify the parameters for luminance/saturation variations. Lum/sat mapping is crap: it should be mapped on an hemisphere instead of cropped planar values.
