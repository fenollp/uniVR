// Shader downloaded from https://www.shadertoy.com/view/4sK3Dt
// written by shadertoy user aiekick
//
// Name: Ray Marching Experiment n&deg;39
// Description: Ray Marching Experiment n&deg;39
...
vec3 effect(vec2 g) 
{
    // Maze 4 (90 chars) from fabriceneyret2 shader : https://www.shadertoy.com/view/4scGWf
   	return vec3(0.03/ fract(   sin(1e5*length (ceil(g)+iGlobalTime/5.5e4)) < 0.  ? g.x :g.y ));
}
