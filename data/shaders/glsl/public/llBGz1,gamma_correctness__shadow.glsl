// Shader downloaded from https://www.shadertoy.com/view/llBGz1
// written by shadertoy user Zavie
//
// Name: Gamma correctness: shadow
// Description: Illustrating the effect of gamma space in shading. Without gamma correction on the left ; with gamma correction on the right (hint: the right is the one you want). Notice the shadow falloff and the rim reflection.
//    
