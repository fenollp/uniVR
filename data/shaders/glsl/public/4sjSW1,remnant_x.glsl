// Shader downloaded from https://www.shadertoy.com/view/4sjSW1
// written by shadertoy user Dave_Hoskins
//
// Name: Remnant X
// Description: Binary subdivision finds the surface really well with this fractal. Two light sources with shadows, and near surface glows. MOUSE X TO TIME WARP
// Remnant X
// by David Hoskins.
