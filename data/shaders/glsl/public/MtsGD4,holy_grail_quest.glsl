// Shader downloaded from https://www.shadertoy.com/view/MtsGD4
// written by shadertoy user eiffie
//
// Name: Holy Grail Quest
// Description: In the never ending quest for the fractal holy grail this was a contender from a few years ago. Of course it is not the 3d mandelbrot we imagine having detail everywhere but it has some nice julias.
