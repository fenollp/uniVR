// Shader downloaded from https://www.shadertoy.com/view/XdcSzH
// written by shadertoy user knightcrawler25
//
// Name: A ray tracer
// Description: A basic raytracer with help from inigo's article: http://www.iquilezles.org/www/articles/simplegpurt/simplegpurt.htm
/* Trying to learn some basic stuff about cg and raytracing. Wanted to replicate this: https://www.youtube.com/watch?v=V5Y06xkRWio
   Not sure how he has handled recursion for refracted and reflective rays but I tried to look everywhere but couldn't find how
   to do it in a shader without it running horrendously slow.
*/
