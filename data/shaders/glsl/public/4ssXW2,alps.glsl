...
//
// Name: Alps
// Description: Uses a ridged fractal noise with corrosion effects for higher altitudes. I tried to remove as many artefacts as possible and still have a long draw distance. Now includes fractal wind. :)
// Alps.
// by David Hoskins.
