// Shader downloaded from https://www.shadertoy.com/view/MdKGWc
// written by shadertoy user dr2
//
// Name: Leaping Balls
// Description: Leaping balls (where are they going?). Mouse to look around.
// "Leaping Balls" by dr2 - 2016
