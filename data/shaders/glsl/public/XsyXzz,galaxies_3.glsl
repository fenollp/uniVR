// Shader downloaded from https://www.shadertoy.com/view/XsyXzz
// written by shadertoy user vox
//
// Name: Galaxies 3
// Description: Galaxies 3
//-----------------SETTINGS-----------------
...
#define time ((saw(float(__LINE__))+1.0)*(iGlobalTime+12345.12345))
