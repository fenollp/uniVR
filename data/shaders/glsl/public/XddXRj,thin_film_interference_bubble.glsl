// Shader downloaded from https://www.shadertoy.com/view/XddXRj
// written by shadertoy user cornusammonis
//
// Name: Thin-Film Interference Bubble
// Description: Simulates thin-film interference patterns on a bubble.  If the bubble appears to be mostly white, check the BUG NOTICE in the source.
/*
