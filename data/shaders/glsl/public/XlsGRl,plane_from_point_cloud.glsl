// Shader downloaded from https://www.shadertoy.com/view/XlsGRl
// written by shadertoy user paniq
//
// Name: Plane From Point Cloud
// Description: fit a plane to a point cloud using least squares via singular value decomposition (SVD); toggle INVERSE_ITER_EIGEN for a cheaper computation of the tangent space only
