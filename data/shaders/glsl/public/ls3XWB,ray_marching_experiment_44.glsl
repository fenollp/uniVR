// Shader downloaded from https://www.shadertoy.com/view/ls3XWB
// written by shadertoy user aiekick
//
// Name: Ray Marching Experiment 44
// Description: Ray Marching Experiment 43
...
{
    vec2 g = p.xz;
    vec3 col =  texture2D(iChannel1, g+iGlobalTime*0.1).rgb;
   	col = clamp(col, 0., 1.);
...
vec4 map(vec3 p)
{
    ...
    {
        dstepf += 0.02;
        return vec4(mk, disp2.yzw*vec3(0.2,0.5,0.2));
    }
    dstepf += 0.01;
    return vec4(mei, disp1.yzw*vec3(0.5,0.2,0.5));
}
