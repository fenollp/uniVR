// Shader downloaded from https://www.shadertoy.com/view/MdBSDt
// written by shadertoy user vgs
//
// Name: Bacterium
// Description: Bacterium, bacteria, bacterias...<br/>My first try at anti-aliasing thanks to eiffie and his shader AA methods.
