// Shader downloaded from https://www.shadertoy.com/view/MsXGR2
// written by shadertoy user rez
//
// Name: Dubstep my ass!
// Description: A little effect I did for my latest demo entitled "Glenz vector form Hell" (http://pouet.net/prod.php?which=61209).<br/>I tried to implement a (very) simple version of my CRT emulation, I'm currently no very satisfied with the result here :3
